...
// sponsors to block
const blockedSponsorsFilename = "./src/data/blocked-sponsors.json";

// filename to output sponsors to
const sponsorsFilename = "./src/data/sponsors.json";
const donationsFilename = "./src/data/donations.json";
