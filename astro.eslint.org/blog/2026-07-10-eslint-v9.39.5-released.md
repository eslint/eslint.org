...
This release backports a fix originally released in [v10.3.0](/blog/2026/05/eslint-v10.3.0-released/) that prevents ESLint from crashing in host environments where [`require.cache`](https://nodejs.org/api/modules.html#requirecache) is unavailable, such as Yarn Plug'n'Play.
