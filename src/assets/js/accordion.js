...
(function (w, doc, undefined) {
    var ARIAaccOptions = {
        ...
        icon:
            '<svg class="accordion-icon" width="12" height="8" aria-hidden="true" focusable="false" viewBox="0 0 12 8"><g fill="none"><path fill="currentColor" d="M1.41.59l4.59 4.58 4.59-4.58 1.41 1.41-6 6-6-6z"/><path d="M-6-8h24v24h-24z"/></g></svg>',
    };
    /**
     * ARIA Accordion
...
for (var i = 0; i < els.length; i++) {
    ...
    var nAccs = new ARIAaccordion(els[i], { withControls: false, showOneAnswerAtATime: false });
