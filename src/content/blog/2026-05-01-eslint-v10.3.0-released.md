...
The [`no-unused-private-class-members`](/docs/latest/rules/no-unused-private-class-members) rule now provides [suggestions](/docs/latest/use/core-concepts/#rule-suggestions) to remove reported unused private class members.
