...
* [`class-methods-use-this`](/docs/latest/class-methods-use-this)
* [`prefer-object-spread`](/docs/latest/prefer-object-spread)
* [`prefer-template`](/docs/latest/prefer-template)
* [`preserve-caught-error`](/docs/latest/preserve-caught-error)
* [`no-unreachable-loop`](/docs/latest/no-unreachable-loop)
