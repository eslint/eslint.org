...
ESLint v10.6.0 introduces a new option `checkRelationalComparisons` for the [`no-constant-binary-expression`](/docs/latest/rules/no-constant-binary-expression) rule.
